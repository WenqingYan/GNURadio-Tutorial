...
# Title: Sdr Hackrf L1
# Generated: Wed Jan 16 16:23:53 2019
...
class SDR_HackRF_L1(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Sdr Hackrf L1")
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(int(samp_rate/channel_width), firdes.low_pass(
        	1, samp_rate, 75e3, 35e3, firdes.WIN_HAMMING, 6.76))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 75e3, 35e3, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=SDR_HackRF_L1, options=None):
